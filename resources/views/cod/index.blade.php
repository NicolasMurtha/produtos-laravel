...
<body>
    ...
    <p>
        <a type="button" class="btn btn-primary btn-sm" href="{{route('cod.create')}}">Novo Codigo</a>
    </p>
...
<form method="POST" action="{{route('produtos.pesquisa')}}">
    ...
    <tr>
        ...
        <td>
            <form action="{{route('cod.destroy', $elemento['id']) }}" method="POST">
                @csrf
                @method ('DELETE')
        ...
        <td><a type="button" class="btn btn-warning btn-sm" href="{{route('cod.edit', $elemento['id'])}}">Alterar</a></td>
    </tr>
