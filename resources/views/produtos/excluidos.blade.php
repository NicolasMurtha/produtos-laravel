...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
    ...
    <title>Lista de produtos deletados</title>
</head>

<body>
    <h1>Lista de Produtos Deletados</h1>
    ...
    <tr>
        ...
        <td>
            <form action="{{route('produtos.forceDestroy', $elemento['id']) }}" method="POST">
                @csrf
                @method ('DELETE')
        ...
        <td><a type="button" class="btn btn-success btn-sm" href="{{route('produtos.restore', $elemento['id'])}}">Restaurar</a></td>
    </tr>
    </tr>
